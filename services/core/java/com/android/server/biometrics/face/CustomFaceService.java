...
public class CustomFaceService {
    ...
    private Intent getServiceIntent() {
        Intent intent = new Intent("com.aospextended.faceunlock.BIND");
        intent.setComponent(ComponentName.unflattenFromString(
                "com.aospextended.faceunlock/com.aospextended.faceunlock.service.FaceAuthService"));
        return intent;
    }

    public String getServicePackageName() {
        return "com.aospextended.faceunlock";
    }
